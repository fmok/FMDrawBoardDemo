...
@interface FMDrawBoarderView()
{
    /** 工具条的view */
    UIView *_toolView;
    
    /** 画板view */
    FMScrollView *_boardView;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //画板view
        FMScrollView * boardV = [[FMScrollView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(toolV.frame), SCREEN_SIZE.width, SCREEN_SIZE.height - CGRectGetMaxY(toolV.frame))];
        
        boardV.layer.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:.5].CGColor;
